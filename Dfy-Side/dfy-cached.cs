// Dafny program dfy-cached.dfy compiled into C#
...
// Command-line arguments: run --no-verify c:\Users\anghe\Desktop\Facultate\VDPD\Proiect\DfyCached\Dfy-Side\dfy-cached.dfy
// dfy-cached.dfy
  ...
  public partial class __default {
    public static void _Main(Dafny.ISequence<Dafny.ISequence<Dafny.Rune>> args)
    {
      if ((new BigInteger((args).Count)) < (new BigInteger(2))) {
        Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Invalid number of arguments.")).ToVerbatimString(false));
        return ;
      }
      Dafny.ISequence<Dafny.Rune> _0_message;
      _0_message = (args).Select(BigInteger.One);
      if ((_0_message).Equals(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("test"))) {
        Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("ok")).ToVerbatimString(false));
      } else {
        Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("error")).ToVerbatimString(false));
      }
    }
  }
